...
public class ReadFromFilesTestCase {
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator().server().given(HttpServerConfigBuilderContext.configure()
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withPath("/user4")
    ...
    private File getTestFiles(String fileName) {
        String changeLater = "/home/senduran/projects/bsenduran/product-gw/protocol/emulator/src/main/resources/";
