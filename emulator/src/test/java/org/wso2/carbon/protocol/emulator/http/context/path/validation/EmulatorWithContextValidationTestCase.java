...
package org.wso2.carbon.protocol.emulator.http.context.path.validation;
...
import org.wso2.carbon.protocol.emulator.http.server.contexts.HttpServerRequestBuilderContext;
...
public class EmulatorWithContextValidationTestCase {
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator().server().given(configure().host("127.0.0.1").port(6065).context("/users"))
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.GET))
                .then(response().withBody("User1").withStatusCode(HttpResponseStatus.OK)
                        .withHeader("Header1", "value1"))

                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.PUT))
                .then(response().withBody("User2").withStatusCode(HttpResponseStatus.OK)
                        .withHeader("Header2", "value2"))

                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.GET).withPath("*")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST)
                        .withPath("*").withBody("User4").withHeader("Header4", "value4"))
                .then(response().withBody("User4").withStatusCode(HttpResponseStatus.OK)
                        .withHeader("Header4", "value4"))

                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.GET).withPath("/user8")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.GET).withPath("/user10")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST)
                        .withPath("/user14").withBody("User14")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST)
                        .withPath("/user15").withBody("User15")
