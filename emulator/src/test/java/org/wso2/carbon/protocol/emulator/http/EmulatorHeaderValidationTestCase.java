...
public class EmulatorHeaderValidationTestCase {
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator().server()
                .given(HttpServerConfigBuilderContext.configure().host("127.0.0.1").port(6065).context("/users")
                        .withEnableWireLog())
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.GET).withPath("user2/"))
                .then(response().withBody("User2").withStatusCode(HttpResponseStatus.OK)
                        .withHeaders(new Header("Header2", "value2")))
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.GET).withPath("user3/"))
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.GET).withPath("user4/")
                        .withHeader("Header-req-1", "value-req1"))
                .then(response().withBody("User4").withStatusCode(HttpResponseStatus.OK)
                        .withHeader("Header5", "value5")).when(HttpServerRequestBuilderContext.request()
                        .withMethod(HttpMethod.GET).withPath("user5/")
                ...
                .then(response().withBody("User5").withStatusCode(HttpResponseStatus.OK)
                        .withHeader("Header6", "value6")).when(HttpServerRequestBuilderContext.request()
                        .withMethod(HttpMethod.GET).withPath("user6/")
