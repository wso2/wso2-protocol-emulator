...
import org.wso2.carbon.protocol.emulator.http.params.QueryParameterOperation;
...
public class EmulatorWithPathValidationTestCase {
    ...
    private HttpServerOperationBuilderContext startHttpEmulator() {
        return Emulator.getHttpEmulator().server().given(HttpServerConfigBuilderContext.configure()
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withBody("User4")
                ...
                .when(HttpServerRequestBuilderContext.request().withMethod(HttpMethod.POST).withBody("User5")
                ...
                .then(response().withBody("User5").withStatusCode(HttpResponseStatus.OK)
                        .withHeader("Header6", "value6")).operation().start();
    }
}
